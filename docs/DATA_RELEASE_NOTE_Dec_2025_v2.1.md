...
All thresholds match the original implementation (5×SD for PCA, 5×MAD for technical, 4×SD for Z-score and pQTL). Pipeline version: v1.4.0

---

**Pipeline Version**: v1.4.0 (January 2026 - Refactored)
